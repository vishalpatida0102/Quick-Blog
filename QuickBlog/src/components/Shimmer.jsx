  ...
  return (
    <div className="flex flex-wrap justify-center gap-6 px-4 py-6">
      {Array(12).fill(0).map((_, index) => (
        <div
          key={index}
          className='w-full max-w-[300px] sm:w-[260px] rounded-lg overflow-hidden shadow hover:scale-102 hover:shadow-primaary/25 duration-300 cursor-pointer animate-pulse bg-white'
        >
          {/* Image Shimmer */}
          <div className='aspect-video bg-gray-300'></div>

          {/* Category Tag Shimmer */}
          <div className='ml-5 mt-4 h-4 w-24 bg-gray-300 rounded-full'></div>
