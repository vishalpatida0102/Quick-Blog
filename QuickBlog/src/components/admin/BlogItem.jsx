  ...
  return (
    <tr className='border-y border-gray-300'>
        ...
        <td className='px-2 py-3 flex text-xs gap-3'>
            <button className='border px-2 py-0.5 mt-1 rounded cursor-pointer'>Unpublish</button>
            <img src={assets.cross_icon} className='w-8 hover:scale-110 transition-all cursor-pointer' alt="img" />
        </td>
